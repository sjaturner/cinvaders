...
invaders.asm: invaders.bin
	z80dasm -l -b blockfile -g0 -t -a $^ | python3 symbolise.py | python3 align.py | sed 's/jp c_end/jp d_first/' | python3 some_comments.py > $@
...
.PHONY: clean
clean:
	rm -f main invaders.asm invaders.bin validate.bin
